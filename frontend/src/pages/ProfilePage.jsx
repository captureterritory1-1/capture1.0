          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-secondary rounded-xl p-4 text-center">
                ...
                <p className="text-2xl font-bold text-foreground">{stats.territories}</p>
              ...
              <div className="bg-secondary rounded-xl p-4 text-center">
                <div 
                  ...
                  style={{ backgroundColor: userPreferences.territoryColor.hex }}
                />
                <p className="text-2xl font-bold text-foreground">{stats.totalArea}</p>
                <p className="text-xs text-muted-foreground">km² Captured</p>
              </div>
              <div className="bg-secondary rounded-xl p-4 text-center">
                <Route className="w-6 h-6 mx-auto text-accent mb-2" />
                <p className="text-2xl font-bold text-foreground">{stats.totalDistance}</p>
          ...
          <CardContent className="p-0">
            {menuItems.map((item, index) => (
              <React.Fragment key={item.label}>
                <button className="w-full flex items-center gap-3 px-4 py-3 hover:bg-secondary/50 transition-colors">
